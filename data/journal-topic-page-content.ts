...
export const journalTopicPageContent: Record<JournalTopicHubId, TopicPageContent> = {
  "better-sleep": {
    ...
    topicIntroduction: {
      ...
      "Inside this topic you will find Sleep Basics guides on sleep stages, why sleep matters, sleep cycles, deep sleep, sleep hygiene, natural sleep improvement, common reasons sleep feels difficult, and how background sound such as green noise can support a quieter room. You will also find articles on bedroom scent, evening wind-down rituals, and gentle incense choices for small spaces. Each piece is meant to stand alone, but together they form a practical map for Better Sleep.",

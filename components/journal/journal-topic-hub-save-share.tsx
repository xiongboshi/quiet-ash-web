...
export function JournalTopicHubSaveShare({ saveSub }: Props) {
  return (
    <section className="journal-topic-page__save-share" aria-label="Save and share">
      <div className="journal-topic-page__save-share-card">
        ...
        <div className="journal-topic-page__save-share-half journal-topic-page__save-share-half--save">
          ...
          <div className="journal-topic-page__save-share-text">
            <p className="journal-topic-page__save-share-label">Save this topic</p>
            <p className="journal-topic-page__save-share-sub">{saveSub}</p>
          </div>
        </div>

        <div className="journal-topic-page__save-share-divider" aria-hidden />

        <div className="journal-topic-page__save-share-half journal-topic-page__save-share-half--share">
          <p className="journal-topic-page__save-share-label">Share this topic</p>
          <div className="journal-topic-page__save-share-icons">
            <button type="button" className="journal-topic-page__save-share-icon" aria-label="Share on Pinterest">
              <PinterestIcon />
            </button>
            <button type="button" className="journal-topic-page__save-share-icon" aria-label="Share on Instagram">
              <InstagramIcon />
            </button>
            <button type="button" className="journal-topic-page__save-share-icon" aria-label="Share by email">
              <Mail {...JOURNAL_EDITORIAL_SHARE_ICON} />
            </button>
            <button type="button" className="journal-topic-page__save-share-icon" aria-label="Copy link">
              <Link2 {...JOURNAL_EDITORIAL_SHARE_ICON} />
            </button>
          </div>
        </div>
      </div>
